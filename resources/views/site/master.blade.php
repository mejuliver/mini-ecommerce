...
<head>
	...
	@yield('top resources')
    <!--[if lt IE 9]>
    <script src="{{ url('/core/site/plugins/html5shiv.min.js') }}"></script>
...
<body class="thehide">
					...
					<div class="col-sm-4">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="{{ url('/home') }}" @if($current_page&&$current_page==='Home'){{'class=active'}}@endif>Home</a></li>
								...
								<li><a href="https://www.dinhi.org/blog">Blog</a></li> 
								<li><a href="https://www.dinhi.org/contact">Contact</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-8">
	...
	<footer id="footer"><!--Footer-->
  	...
  	<script>var site_link="{{url('/')}}"@if(Auth::guard('dashboard')->check()||Auth::guard('user')->check()),username = "@if(Auth::guard('dashboard')->check()){{ Auth::guard('dashboard')->user()->username }}@elseif(Auth::guard('user')->check()){{ Auth::guard('user')->user()->username }}@else{{ 'Not logged' }}@endif";@endif</script>
	...
	<script src="{{ url('/core/site/plugins/price-range/price-range.min.js') }}"></script>
    <script src="{{ url('/core/site/plugins/prettyPhoto/prettyPhoto.min.js') }}"></script>
    ...
    <script src="{{ url('/core/site/js/main.js') }}"></script>
</body>
</html>